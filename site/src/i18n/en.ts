...
const en = {
  ...
  'clinical.closed': 'Recruitment closed',
  ...
  'search.filter.anyStatus': 'Any status',
  'search.filter.statusRecruiting': 'Recruiting',
  'search.filter.statusClosed': 'Recruitment closed',
  'search.filter.startDate': 'Period',
  'search.filter.dateYearAny': 'Year',
  'search.filter.dateMonthAny': 'Month',
