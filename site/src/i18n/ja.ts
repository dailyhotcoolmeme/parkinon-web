...
const ja: Dict = {
  ...
  'search.filter.anyStatus': '募集状況すべて',
  'search.filter.statusRecruiting': '募集中',
  'search.filter.statusClosed': '募集終了',
  'search.filter.startDate': '期間',
  'search.filter.dateYearAny': '年',
  'search.filter.dateMonthAny': '月',
  'search.filter.dateYearUnit': '{n}年',
  'search.filter.dateMonthUnit': '{n}月',
